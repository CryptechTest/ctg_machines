    ...
    core.register_node(node_name, {
        ...
        digiline = {
            ...
            effector = {
                ...
                action = ctg_machines.chem_lab_digiline_effector
            }
        }
    })
...
ctg_machines.register_chem_lab({
    tier = "LV",
    demand = {500, 480, 450},
    produced = 20,
    speed = 2,
...
local lcm = "ctg_machines:lv_chemical_lab"
local mcm = "ctg_machines:mv_chemical_lab"

-- lv
if core.get_modpath("ctg_ruby") then        
    core.register_craft({
        output = "ctg_machines:lv_chemical_lab",
...
-- mv
core.register_craft({
    output = "ctg_machines:mv_chemical_lab",
    recipe = {{bt, bt, bt}, {cr, lcm, cr}, {cc, mvt, cc}}
})
-- hv
core.register_craft({
    output = "ctg_machines:hv_chemical_lab",
    recipe = {{bt, gcr, bt}, {bt, mcm, bt}, {cc, hvt, cc}}
})

--local coolant_image = "ctg_machines_coolant_source_animated.png"
--ctg_machines.coolant_bottle_image = "[combine:16x16:0,0=" .. coolant_image .. "^vessels_glass_bottle_mask.png^[makealpha:0,254,0"
