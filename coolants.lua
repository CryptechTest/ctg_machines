core.register_node("ctg_machines:coolant_source", {
    ...
    drowning = 1,
    liquidtype = "source",
    liquid_alternative_flowing = "ctg_machines:coolant_flowing",
    liquid_alternative_source = "ctg_machines:coolant_source",
...
core.register_node("ctg_machines:coolant_flowing", {
...
if core.get_modpath("radiant_damage") then
    ...
    radiant_damage.register_radiant_damage("coolant", {
        ...
        emitted_by = {
            ["ctg_machines:coolant_source"] = 1,
            ["ctg_machines:coolant_flowing"] = 1
        },
        attenuated_by = {
            ["group:stone"] = 0.5,
...
if core.get_modpath("bucket") then
    bucket.register_liquid("ctg_machines:coolant_source", "ctg_machines:coolant_flowing", "ctg_machines:bucket_coolant",
...
if core.get_modpath("bottles") then
    ...
    --[[core.register_node(":ctg_machines:bottle_of_coolant", {
    ...
    bottles.register_filled_bottle({
        target = "ctg_machines:coolant_source",
        sound = "default_water_footstep",
        modname = "ctg_machines",
    ...
    local contents_node = core.registered_nodes['ctg_machines:bottle_of_coolant']
    ...
    core.register_abm({
        ...
        nodenames = {"ctg_machines:coolant_source"},
    ...
    core.register_abm({
        ...
        nodenames = {"ctg_machines:coolant_flowing"},
        neighbors = {"air", "vacuum:vacuum", "vacuum:atmos_thin"},
        interval = 4,
        chance = 6,
        action = function(pos)
