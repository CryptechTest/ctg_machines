...
ctg_machines.hydrogren_bottle_image = "vessels_steel_bottle.png^[colorize:#ff333380^bottle_top.png"

minetest.register_craftitem("ctg_machines:hydrogen_bottle", {
    description = "Hydrogen Bottle",
    inventory_image = ctg_machines.hydrogren_bottle_image
})
